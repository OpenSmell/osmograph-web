...
| [`OPENSMELL_MASTER.md` §3](../../../private/OPENSMELL_MASTER.md) | The `.osmell` v1.1.0 container spec (ZIP + CSV + JSON), quality taxonomy, and manifest conventions. |
...
| Sensor theory: effective dimensionality, drift, batch ±20%, humidity common-mode | `../../../private/OPENSMELL_MASTER.md` §6 |
| Canonical array-capacity Table 2 and MOX-boundary Table 3 | `../../../interoperability/canonical_experiments/generate_tables.py` |
| Audit of the negative results | `../../../private/OPENSMELL_MASTER.md` §8 |
